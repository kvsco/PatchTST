...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='Autoformer', help='model name, options: [Autoformer, Informer, Transformer]')
    ...
    parser.add_argument('--target', type=str, default='machine_7_8', help='target feature in S or MS task') # txn_elapse, tps
